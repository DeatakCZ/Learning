...
Q_CONSTINIT static const qt_meta_stringdata_CLASSModelENDCLASS_t qt_meta_stringdata_CLASSModelENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(6, 12),  // "operandFalse"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 7),  // "operand"
        QT_MOC_LITERAL(28, 10)   // "zeroDivide"
    },
    "Model",
    "operandFalse",
    "",
...
void Model::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->operandFalse((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->zeroDivide(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Model::operandFalse; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Model::*)();
            if (_t _q_method = &Model::zeroDivide; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Model::operandFalse(int _t1)
{
